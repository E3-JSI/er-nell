...
# get related events for the keyword
    ...
    q.addRequestedResult(RequestEventsInfo(count = 3, sortBy = "rel", returnInfo = ReturnInfo(eventInfo=EventInfoFlags(title=True, summary=False, articleCounts=False, concepts=False, categories=False, location=True, date=True))))
